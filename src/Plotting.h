...
//                    std::vector<double> all_ypos,
                    std::vector<double> &xpos_infected,
                    std::vector<double> &ypos_infected,
                    std::vector<double> &xpos_immune,
                    std::vector<double> &ypos_immune,
                    std::vector<double> &xpos_dead,
                    std::vector<double> &ypos_dead,
                    std::vector<double> &xpos_alive,
                    std::vector<double> &ypos_alive
                    )
{
